...
const SignIn = ({ providers }) => {
  return (
    <div className='bg-slate-200 h-screen sm:grid grid-cols-1 lg:grid-cols-2 items-center mx-auto justify-center'>
      <Head>
      ...
      <div className='hidden md:col-span-1 lg:inline-grid mx-auto'>
        <div className='flex items-center justify-center bg-slate-900 p-3 rounded-xl shadow-lg'>
          <img
      ...
      <div className='flex flex-col justify-center items-center sm:bg-slate-100 h-max lg:w-max sm:rounded-xl pb-20 mx-auto lg:mx-0 sm:shadow-lg sm:shadow-blue-300 transition-all duration-1000 ease-in-out'>
        ...
        <p className='px-10 text-center text-xs italic text-slate-400 py-8'>
        ...
        <div>
          <h1 className='capitalize text-center'>Descarga la app</h1>
